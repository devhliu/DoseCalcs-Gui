...
//
// 
/// \file G4TNestedParamSteppingAction.cc
/// \brief Implementation of the G4TNestedParamSteppingAction class
...
//G4ThreadLocal G4double G4TNestedParamSteppingAction::edep;
//G4ThreadLocal G4String G4TNestedParamSteppingAction::reg;
//G4ThreadLocal unsigned int  G4TNestedParamSteppingAction::CN;

G4TNestedParamSteppingAction::G4TNestedParamSteppingAction(G4TRunAction* ra):G4UserSteppingAction(),RunAction(ra){}


G4TNestedParamSteppingAction::~G4TNestedParamSteppingAction(){}


void G4TNestedParamSteppingAction::UserSteppingAction(const G4Step* step)
{
